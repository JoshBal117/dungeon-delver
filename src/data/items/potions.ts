...
export const POTIONS: ItemTemplate[] = [
  ...
  { code: 'mana-potion',   name: 'Potion of Mana',        type: 'potion', rarity: 'uncommon', onUse: 'mana_25' },
  ...
  { code: 'heal-potion',   name: 'Healing Potion',        type: 'potion', rarity: 'uncommon', onUse: 'heal_25' },
